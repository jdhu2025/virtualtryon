...
export function SiteFooter() {
  ...
  return (
    <footer className="border-t border-[#eaded2] bg-[#fffaf5]">
      <div className="mx-auto grid max-w-7xl gap-10 px-5 py-12 text-sm text-[#6d5a4c] lg:grid-cols-[1.5fr_1fr_1fr_1fr] lg:px-8">
        <div>
          <div className="flex items-center gap-3">
            <div className="flex h-10 w-10 items-center justify-center rounded-2xl bg-[#a9472f] text-sm font-semibold text-white">
              AI
            </div>
            <div>
              ...
              <p className="text-xs text-[#735744]">
        ...
        <div>
          ...
          <div className="mt-4 space-y-3">
            <Link href="/auth/register" prefetch={false} className="block hover:text-[#d96d4f]">
              {t(locale, "Start free", "免费开始")}
            </Link>
            <Link href="/auth/login" prefetch={false} className="block hover:text-[#d96d4f]">
              {t(locale, "Log in", "登录")}
            </Link>
            <Link href="/blog" prefetch={false} className="block hover:text-[#d96d4f]">
              {t(locale, "Blog", "博客")}
            </Link>
          </div>
        </div>
        ...
        <div>
          ...
          <div className="mt-4 space-y-3">
            <Link href="/about" prefetch={false} className="block hover:text-[#d96d4f]">
              {t(locale, "About", "关于我们")}
            </Link>
            <Link href="/contact" prefetch={false} className="block hover:text-[#d96d4f]">
              {t(locale, "Contact", "联系我们")}
            </Link>
            <Link href="/refund" prefetch={false} className="block hover:text-[#d96d4f]">
        ...
        <div>
          ...
          <div className="mt-4 space-y-3">
            <Link href="/terms" prefetch={false} className="block hover:text-[#d96d4f]">
              {t(locale, "Terms of service", "服务条款")}
            </Link>
            <Link href="/privacy" prefetch={false} className="block hover:text-[#d96d4f]">
      ...
      <div className="border-t border-[#eaded2] px-5 py-4 text-center text-xs text-[#735744]">
